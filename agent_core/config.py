...
def build_system_prompt() -> str:
    return (
        ...
        "4) If user asks post-analysis/report/stability diagnostics, call analyze_with_r.\n"
        "5) If tool returns validation_error/optimization_infeasible/optimization_unbounded, self-correct and try again.\n"
        "6) Keep answers concise and execution-focused.\n"
        "7) Never fabricate tool outputs; rely only on tool observations.\n"
        "8) CRITICAL: Always include ALL required arguments when calling a tool. Never call a tool with empty arguments {}.\n"
