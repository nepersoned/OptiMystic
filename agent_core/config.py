...
def build_system_prompt() -> str:
    return (
        ...
        "\n"
        "## DOMAIN DETECTION\n"
        "Infer the domain from column names and user description:\n"
        "  - vehicle / route / depot / delivery / latitude / longitude → vrp\n"
        "  - shift / worker / employee / schedule / availability → scheduling\n"
        "  - length / stock / cut / waste / pattern → cutting\n"
        "  - weight / item / capacity / packing → packing\n"
        "  - demand / forecast / inventory / stock → resourcing or vrp\n"
        "\n"
        "## PIPELINE TOOLS\n"
